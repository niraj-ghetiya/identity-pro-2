...
import { ArrowLeft, User, Mail, Phone, Calendar, MapPin, FileText, CheckCircle2, Shield, XCircle, RotateCcw, Check, X, Bot } from "lucide-react";
...
const KYCDetail = () => {
  ...
  // --- AI Note logic (mock) ---
  // In a real app, this would be generated by an AI model based on the KYC data.
  // Here, we provide a helpful, context-aware suggestion for the admin.
  let aiNote = "";
  if (record.status === "approved") {
    aiNote = "AI Review: This KYC application appears genuine. All details and documents are consistent. No risk factors detected.";
  } else if (record.status === "pending") {
    aiNote = "AI Suggestion: Please review the submitted documents and verify the user's selfie for liveness. No immediate red flags detected.";
  } else if (record.status === "under_review") {
    aiNote = "AI Notice: The application is under review. Double-check document clarity and address details for accuracy.";
  } else if (record.status === "rejected") {
    aiNote = "AI Alert: This application was previously rejected. Please ensure the rejection reason is documented and communicate with the user if needed.";
  } else {
    aiNote = "AI Info: No specific suggestions for this application.";
  }
        ...
        <div className="flex flex-col gap-4">
          ...
          <Card className="border-primary/30 bg-primary/5 shadow-sm">
            <CardHeader className="flex flex-row items-center gap-2 pb-2">
              ...
              <CardTitle className="text-base">AI Note</CardTitle>
            </CardHeader>
            <CardContent>
